...
public class EECS4313AllBlackBoxTests {
	@Test
	public void testMinuteString() {
		...
		//Class 5: Minute/60 > 1 and Minute%60 > 1 (valid input) --Testing hours more than one with some minutes
		assertEquals("2 Hours 25 Minutes",DateUtil.minuteString(145));
		//Class 6: Minute/60 > 1 and Minute%60 = 1 (valid input) --Testing hore more than one with some minutes 
